...
const isBeginnerLevelSentence = (sentence) => {
    ...
    if (complexWordCount > maxComplexWords)
        return false;
...
const cleanSubtitle = (subtitleLines) => {
    ...
    cleanedSubtitles = cleanedSubtitles.filter((line) => {
        return (!line.toLowerCase().includes("synced and corrected by") &&
...
export const getBeginnerSentence = async (filePath) => {
